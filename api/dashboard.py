"""Dashboard service APIs: weather, cities, hotels, deals, maps, tools."""
...
# ---- Curated seed data (foreigner-relevant signals) ----

CITIES = [
    {"id": "beijing", "name": "Beijing", "cn": "北京", "tagline": "Forbidden City, Great Wall, hutongs",
     "best_months": "Apr-May, Sep-Oct", "lat": 39.9042, "lon": 116.4074, "image_tone": "ink-mountain"},
    {"id": "shanghai", "name": "Shanghai", "cn": "上海", "tagline": "Bund skyline, French Concession, art",
     "best_months": "Mar-May, Sep-Nov", "lat": 31.2304, "lon": 121.4737, "image_tone": "neon-river"},
    {"id": "chengdu", "name": "Chengdu", "cn": "成都", "tagline": "Pandas, spicy hotpot, slow teahouses",
     "best_months": "Mar-Jun, Sep-Nov", "lat": 30.5728, "lon": 104.0668, "image_tone": "bamboo"},
    {"id": "xian", "name": "Xi'an", "cn": "西安", "tagline": "Terracotta Army, Muslim Quarter, city wall",
     "best_months": "Mar-May, Sep-Oct", "lat": 34.3416, "lon": 108.9398, "image_tone": "loess"},
    {"id": "guilin", "name": "Guilin", "cn": "桂林", "tagline": "Karst peaks, Li River, Yangshuo",
     "best_months": "Apr-Oct", "lat": 25.2736, "lon": 110.2907, "image_tone": "river"},
    {"id": "hangzhou", "name": "Hangzhou", "cn": "杭州", "tagline": "West Lake, Longjing tea, silk roads",
     "best_months": "Mar-May, Sep-Nov", "lat": 30.2741, "lon": 120.1551, "image_tone": "lake"},
    {"id": "suzhou", "name": "Suzhou", "cn": "苏州", "tagline": "Classical gardens, canals, embroidery",
     "best_months": "Apr-Jun, Sep-Nov", "lat": 31.2989, "lon": 120.5853, "image_tone": "garden"},
    {"id": "yunnan", "name": "Lijiang & Dali", "cn": "丽江·大理", "tagline": "Naxi/Bai culture, Erhai lake",
     "best_months": "Mar-Jun, Sep-Nov", "lat": 25.6053, "lon": 100.2675, "image_tone": "mountain"},
]


HOTELS = [
    {"id": "h-beijing-1", "city": "beijing", "name": "Hutong Courtyard Boutique",
     "foreigner_friendly": True, "english_service": True, "foreign_card": True, "metro_min": 6,
     "neighborhood": "Dongcheng / Nanluoguxiang", "rating": 4.6, "price_band": "$$"},
    {"id": "h-shanghai-1", "city": "shanghai", "name": "Bund Riverside Hotel",
     "foreigner_friendly": True, "english_service": True, "foreign_card": True, "metro_min": 3,
     "neighborhood": "Huangpu / Bund", "rating": 4.7, "price_band": "$$$"},
    {"id": "h-chengdu-1", "city": "chengdu", "name": "Panda Garden Inn",
     "foreigner_friendly": True, "english_service": True, "foreign_card": False, "metro_min": 8,
     "neighborhood": "Jinjiang / Chunxi", "rating": 4.5, "price_band": "$$"},
    {"id": "h-xian-1", "city": "xian", "name": "City Wall View Lodge",
     "foreigner_friendly": True, "english_service": True, "foreign_card": True, "metro_min": 5,
     "neighborhood": "Beilin / Bell Tower", "rating": 4.4, "price_band": "$$"},
    {"id": "h-guilin-1", "city": "guilin", "name": "Li River Boutique",
     "foreigner_friendly": True, "english_service": False, "foreign_card": False, "metro_min": 0,
     "neighborhood": "Yangshuo Old Town", "rating": 4.6, "price_band": "$$"},
    {"id": "h-hangzhou-1", "city": "hangzhou", "name": "West Lake Tea House Hotel",
     "foreigner_friendly": True, "english_service": True, "foreign_card": True, "metro_min": 7,
     "neighborhood": "Xihu / West Lake", "rating": 4.7, "price_band": "$$$"},
]


DEALS = [
    {"id": "d-hotpot-cd", "city": "chengdu", "title": "Authentic Sichuan Hotpot for 2",
     "category": "dining", "discount": "-35%", "english_menu": True, "foreign_card": False,
     "vendor": "Shu Da Xia 蜀大侠", "address_cn": "成都市锦江区春熙路 12 号"},
    {"id": "d-tea-hz", "city": "hangzhou", "title": "Longjing Tea Tasting + West Lake Walk",
     "category": "experience", "discount": "-20%", "english_menu": True, "foreign_card": True,
     "vendor": "Lao Long Jing Tea House", "address_cn": "杭州市西湖区龙井路 1 号"},
    {"id": "d-roastduck-bj", "city": "beijing", "title": "Roast Duck Set for 2",
     "category": "dining", "discount": "-25%", "english_menu": True, "foreign_card": True,
     "vendor": "Siji Minfu 四季民福", "address_cn": "北京市东城区故宫旁"},
    {"id": "d-river-gl", "city": "guilin", "title": "Li River Bamboo Raft Cruise",
     "category": "experience", "discount": "-15%", "english_menu": False, "foreign_card": False,
     "vendor": "Yangshuo Raft Co.", "address_cn": "桂林市阳朔县兴坪镇"},
]
...
TOOLS = [
    ...
    {"id": "sim", "title": "SIM / eSIM",
     "summary": "China Unicom or Mobile prepaid SIM at the airport; eSIMs from Airalo/Holafly.",
     "steps": [
    ...
    {"id": "transit", "title": "Trains & Metro",
     ...
     "steps": [
         "Use 12306 English app or Trip.com for high-speed rail.",
         "Carry passport — needed at every station turnstile.",
         "Use Alipay or WeChat for metro QR tickets in major cities.",
     ]},
    {"id": "emergency", "title": "Emergency",
     "summary": "Police 110, Ambulance 120, Fire 119. Embassy contacts.",
     "steps": [
         "Save your embassy phone before travel.",
...
def _maps(environ, start_response):
    ...
    if city:
        pois = [
            {"name": f"{city['name']} downtown", "lat": city["lat"], "lon": city["lon"], "kind": "center"},
            {"name": f"{city['name']} central station", "lat": city["lat"] + 0.01,
             "lon": city["lon"] + 0.01, "kind": "transit"},
        ]
